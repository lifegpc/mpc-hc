...
public:
    ...
    bool Open(BYTE* data, int length, int CharSet, CString provider, CString lang, CString videoName, CString ext = _T(""));
    bool Open(CString data, CTextFile::enc SaveCharSet, int ReadCharSet, CString provider, CString lang, CString videoName, CString ext = _T(""));
